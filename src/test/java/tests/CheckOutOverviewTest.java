...
public class CheckOutOverviewTest extends BaseTest {
	...
	@Test
	public void VerifyNavigationBackHome() {
		...
		finishPage.ClickonBackHome();

		Assert.assertEquals(finishPage.getTitleAfterBackHome(), "Products", "You are not entered in the Home Page");
